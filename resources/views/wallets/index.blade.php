            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="section-title text-center">
                        ...
                        <h5>{{trans('wallets.deposit.title_under')}}</h5>
                    </div>
                </div>
                    ...
                    <div class="row alert alert-danger mt-30 user_bank_account " style="background-color:#ffeebd;border-color:#ffeebd;">
                        <div class="col-lg-12 col-md-12 p-0">
                            <div class="col-lg-12 col-md-12 col-sm-12 mt-10"style="padding:0px;">
                                ...
                                <p class="mb-20 mt-10 font-bold" style=" font-size: 16px;">{{trans('wallets.deposit.user_info.1')}}</p>
                                <p class="mb-20 mt-10 font-bold" style=" font-size: 16px;">{{trans('wallets.deposit.user_info.2')}}</p>
                            </div>
