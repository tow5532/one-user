                    ...
                    <form class="form-row form__auth" role="form"   action="{{ route('withdrawals.register') }}" method="POST" name="frm" autocomplete="off">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3   ">
                            <div class="form-group align-middle">
                                <label class="mb-10 mt-10  font-weight-bold " for="Amounts">{{trans('wallets.withdrawals.depositAmounts')}}</label>
                            </div>
                        </div>
                        ...
                        <!--<div class="col-lg-12 col-md-12 col-sm-12 mb-20 ">
                            <h6 class="text-primary" >*{{trans('wallets.withdrawals.minimum')}} {{number_format($refundMin)}}{{trans('wallets.withdrawals.minimum2')}}.</h6>
                        </div>-->
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <div class="form-group">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9">
                            <div class="form-group">
                                <input type="text" class="form-control withdrawals_amounts numberOnly2" id="withdrawals_amounts" placeholder="{{trans('wallets.withdrawals.minimum')}} {{number_format($refundMin)}}{{trans('wallets.withdrawals.minimum2')}}" name="withdrawals_amounts" >
                            </div>
                        </div>
